	...
	<div class="container-fluid">
		...
		<div class="row row-offcanvas row-offcanvas-left">
			...
			<div class="col-md-9 col-lg-10 main">
				<h2>Lista de Ubicación de los Estantes</h2>
				<div class="panel-heading">
					<div class="row">
						...
						<div class="col-md-2" align="right">
							<button type="button" id="addRack" class="btn btn-info" title="Agregar Estante"><span class="glyphicon glyphicon-plus">Agregar</span></button>
						</div>
					</div>
				</div>
				...
				<form method="post" id="rackForm">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title"><i class="fa fa-plus"></i> Editar Estante</h4>
						</div>
						<div class="modal-body">

							<div class="form-group">
								<label for="rack" class="control-label">Estante</label>
								<input type="text" name="name" id="name" autocomplete="off" class="form-control" placeholder="Nombre del Estante" />
