				...
				<div class="panel-heading">
					<div class="row">
						...
						<div class="col-md-2" align="right">
							<button type="button" id="addAuthor" class="btn btn-info" title="Agregar Usuario"><span class="glyphicon glyphicon-plus">Agregar Autor</span></button>
						</div>
					</div>
				</div>
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<div class="form-group">
								<label for="Income" class="control-label">Autor</label>
